...
def test_any_unmergableedge():
    deviceTopo, comp_graph = init_computing_and_device_graph(6, model_type=TFModelEnum.ALEXNET)
...
def visualize_graph_comparison():
    deviceTopo, comp_graph = init_computing_and_device_graph(6, model_type=TFModelEnum.SMALL)
