...
def init_computing_and_device_graph(num_device, model_type=TFModelEnum.SMALL, gpu_per_server=1,
                                    intra_server_bandwidth=50, intel_server_bandwidth=20) \
    ...
    deviceTopo.generata_fully_connected_topo(num_device, intra_server_bandwidth, intel_server_bandwidth, gpu_per_server)
